...
struct LocationDate: Identifiable {
    let city: String
    ...
    static let london = LocationDate(city: "London", timeline: londonTimeline)
    static let miami = LocationDate(city: "Miami", timeline: miamiTimeline)
...
let miamiTimeline = [
    ...
    WeatherEntry(date: Date(), city: "Miami", temperature: 90,
                 description: "Tropical", icon: "tropicalstorm",
                 image: "torpical", url: tropicalUrl),
