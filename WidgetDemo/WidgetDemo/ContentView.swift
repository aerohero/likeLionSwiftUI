        ...
        NavigationStack(path: $path) {
            ...
            .onOpenURL { url in
                ...
                switch url {
                    ...
                    case hailUrl: path.append(WeatherType(name: "Thunder Storm", icon: "cloud.bolt.rain"))
                    case hailUrl: path.append(WeatherType(name: "Tropical Storm", icon: "tropicalstorm"))
                    default:
                        break
                }
            }
